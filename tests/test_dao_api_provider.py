...
class AuthTestCase(unittest.TestCase):
    ...
    def test_locations(self, mock):
        ...
        status_code, json_response = dao.api_provider.get_locations(DEFAULT_CONFIGURATION, DEFAULT_PROVIDER)
        mock.assert_called_once_with("GET", "/provider/locations?cookbook_tag=%s&provider=%s" %(DEFAULT_CONFIGURATION, DEFAULT_PROVIDER))
    ...
    def test_hardwares_ok(self, mock):
        ...
        status_code, json_response = dao.api_provider.get_hardwares(DEFAULT_PROVIDER, DEFAULT_LOCATION)
        mock.assert_called_once_with("GET", "/provider/hardware?provider=%s&location=%s" % (DEFAULT_PROVIDER, DEFAULT_LOCATION))
