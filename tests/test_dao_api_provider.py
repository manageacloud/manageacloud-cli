...
class AuthTestCase(unittest.TestCase):
    ...
    def test_hardwares_ok(self, mock):
        ...
        status_code, json_response = maccli.dao.api_provider.get_hardwares(DEFAULT_PROVIDER, DEFAULT_LOCATION)
        mock.assert_called_once_with("GET", "/provider/hardware?provider=%s&location=%s" % (
        DEFAULT_PROVIDER, DEFAULT_LOCATION))
