...
MOCK_PARSE_MACFILE_AWS_ROLE = OrderedDict([('postgres', OrderedDict([('instance create', OrderedDict([('branch', 'master'), ('configuration', 'postgres_93_default'), ('deployment', 'testing'), ('environment', [OrderedDict([('DBNAME', 'pgbench')]), OrderedDict([('PGUSER', 'benchuser')])]), ('name', ''), ('release', 'any')]))])), ('pgbench', OrderedDict([('instance create', OrderedDict([('branch', 'master'), ('configuration', 'pgbench'), ('deployment', 'testing'), ('environment', [OrderedDict([('DBNAME', 'pgbench')]), OrderedDict([('PGUSER', 'benchuser')]), OrderedDict([('IP', 'postgres.PUBLIC_IP')]), OrderedDict([('BENCH_CREATION', '-i -s 70')]), OrderedDict([('BENCH_TEST', '-c 4 -j 2 -T 10')])]), ('name', ''), ('release', 'any')]))]))])
MOCK_PARSE_MACFILE_AWS_INF  = OrderedDict([('postgres', OrderedDict([('hardware', 'm3.medium'), ('location', 'us-east-1'), ('provider', 'amazon'), ('role', 'postgres'), ('amount', 1)])), ('pgbench', OrderedDict([('hardware', 'm3.medium'), ('location', 'us-east-1'), ('provider', 'amazon'), ('role', 'pgbench'), ('amount', 1)]))])

MOCK_PARSE_MACFILE_AWS_NO_ORDER_INF  = OrderedDict([('postgres', OrderedDict([('location', 'us-east-1'), ('hardware', 'm3.medium'), ('provider', 'amazon'), ('role', 'postgres'), ('amount', 1)])), ('pgbench', OrderedDict([('hardware', 'm3.medium'), ('location', 'us-east-1'), ('provider', 'amazon'), ('role', 'pgbench'), ('amount', 1)]))])
